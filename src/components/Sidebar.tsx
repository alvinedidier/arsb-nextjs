...
export default function Sidebar() {
  return (
    ...
    <div className="w-64 absolute sm:relative shadow h-screen flex-col justify-between hidden sm:flex">
                        <div className="px-8">
                            ...
                            <ul className="mt-12">
                                <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manage(0)" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manage/campaigns" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manage/advertisers" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manage/agencies" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
