    ...
    <>
      ...
      <Breadcrumb className="py-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/manage/campaigns">Campagnes</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>{campaign.campaign_name}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-60">
              ...
              <DropdownMenuItem>
                <Link href={`/manage/campaigns/${campaign.campaign_id}/report`} className="flex items-center">
                  <FileText className="mr-2 h-4 w-4" />
                  <span>Permalien de la campagne</span>
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem>
