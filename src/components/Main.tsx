  ...
  return (
 	<>
                <div className="flex flex-no-wrap">
                     ...
                     <div className="w-64 absolute sm:relative bg-gray-800 shadow xl:h-full md:h-full flex-col justify-between hidden sm:flex">
                        <div className="px-8">
                            ...
                            <ul className="mt-12">
                                <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manage" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manager/campaigns" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        ...
                                        <span className="text-sm ml-2">Campagnes</span>
                                     </Link>
                                    <div className="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">8</div>
                                </li>
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manager/advertisers" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        ...
                                        <span className="text-sm ml-2">Annonceurs</span>
                                    </Link>
                                </li>
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <Link href="/manager/agencies" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                            ...
                            <div className="flex justify-center mt-48 mb-4 w-full">
                                <div className="relative">
                                    ...
                                    <input className="bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-gray-300 placeholder-gray-400 bg-gray-100 pl-10 py-2" type="text" placeholder="Recherche" />
                                </div>
                            </div>
                        </div>
